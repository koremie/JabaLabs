...
public class Malacostraca extends Arthropoda {
	...
	public Malacostraca(String name, String species, String size, String age, int lifespanInYears, DangerLevel dangerLevel,
			String diet, float daysNotFed, Boolean hasClaws) {
